...
function shapeSpace_include_custom_jquery() {
  ...
  wp_enqueue_script('lightbox-min-js', 'https://cdnjs.cloudflare.com/ajax/libs/lightbox2/2.10.0/js/lightbox.min.js', array(), null, false);
  wp_enqueue_script('tabcordion-js', '/wp-content/themes/ucalgary/js/tabcordion.js', array(), null, false);
  //wp_enqueue_script('fontawesome', 'https://pro.fontawesome.com/releases/v5.8.1/js/all.js', array(), null, false);
}
...
function theme_add_bootstrap(){
    ...
    wp_enqueue_style( 'lightbox-min-css', 'https://cdnjs.cloudflare.com/ajax/libs/lightbox2/2.10.0/css/lightbox.min.css' );
    wp_enqueue_style( 'all-css', 'https://pro.fontawesome.com/releases/v5.8.1/css/all.css' );
