...
function shapeSpace_include_custom_jquery() {
  ...
  wp_enqueue_script('jquery', 'https://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js', array(), null, false);
  wp_enqueue_script('bootstrap-js', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js', array(), null, false);
  wp_enqueue_script('bootstrap-select-js', 'https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.13.1/js/bootstrap-select.min.js', array(), null, false);
  wp_enqueue_script('jquery-ui', 'https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js', array(), null, false);
  wp_enqueue_script('modernizr-js', '/wp-content/themes/ucalgary/bootstrap/js/modernizr.js', array(), null, false);
  wp_enqueue_script('theme-js', '/wp-content/themes/ucalgary/bootstrap/js/theme.js', array(), null, false);
  wp_enqueue_script('jquery-ucMenu-js', '/wp-content/themes/ucalgary/bootstrap/js/jquery.ucMenu.js', array(), null, false);
  wp_enqueue_script('jquery-svgInject-js', '/wp-content/themes/ucalgary/bootstrap/js/jquery.svgInject.js', array(), null, false);
  wp_enqueue_script('tabcordion-js', '/wp-content/themes/ucalgary/bootstrap/js/tabcordion.min.js', array(), null, false);
  wp_enqueue_script('jquery-matchHeight-js', '/wp-content/themes/ucalgary/bootstrap/js/jquery.matchHeight.js', array(), null, false);
  wp_enqueue_script('owl-carousel-js', '/wp-content/themes/ucalgary/bootstrap/js/owl.carousel.js', array(), null, false);
  wp_enqueue_script('fontawesome', 'https://use.fontawesome.com/a4a20cabef.js', array(), null, false);
}
add_action('wp_enqueue_scripts', 'shapeSpace_include_custom_jquery');

// Add bootstrap support to the Wordpress theme 
function theme_add_bootstrap(){ 
    wp_enqueue_style( 'bootstrap-css', '/wp-content/themes/ucalgary/bootstrap/css/bootstrap.css' );
